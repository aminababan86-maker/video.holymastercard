...
<div style="background: #ec4899; padding: 20px; border-radius: 12px; color: white; margin: 20px 0;">
  <p style="margin: 0; font-size: 16px; color: white;">🏢 微软学生优惠申请指南</p>
</div>

## 📋 教程列表

<div style="background: #ec4899; padding: 3px; border-radius: 16px; margin: 30px 0; box-shadow: 0 8px 24px rgba(236, 72, 153, 0.25);">
  <div style="background: white; padding: 30px; border-radius: 14px;">
    ...
    <h3 style="margin: 0 0 15px 0; color: #ec4899; font-size: 22px; text-align: center;">微软学生优惠教程</h3>
