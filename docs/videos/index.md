...
<div style="text-align: center; margin: 40px 0;">
  <a href="/" style="display: inline-block; padding: 12px 30px; background: #f8f9fa; color: #666; text-decoration: none; border-radius: 8px; font-weight: 600; border: 2px solid #e9ecef; transition: all 0.3s ease;">← 返回首页</a>
</div>
